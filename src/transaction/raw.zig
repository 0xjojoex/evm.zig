...
fn decodeLegacy(allocator: std.mem.Allocator, bytes: []const u8, sender: Address) Error!transaction.Transaction {
...
fn decodeTyped(allocator: std.mem.Allocator, typed: transaction_envelope.TypedEnvelope, sender: Address) Error!transaction.Transaction {
