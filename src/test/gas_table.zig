...
fn actual(comptime revision: Revision) Row {
    ...
    return .{
        ...
        .tx_intrinsic_base = spec.transaction.intrinsicBaseGas(.{}) catch unreachable,
        .calldata_nonzero_byte = spec.transaction.calldataGas(&nonzero) catch unreachable,
        .calldata_zero_byte = spec.transaction.calldataGas(&zero) catch unreachable,
