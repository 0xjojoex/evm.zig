...
pub fn builderDepositFinalizeSystemCall(system_address: address.Address, gas: u64, state_gas: u64) types.FinalizeSystemCall {
    return .{
        .call = .{
...
pub fn builderExitFinalizeSystemCall(system_address: address.Address, gas: u64, state_gas: u64) types.FinalizeSystemCall {
    return .{
        .call = .{
            .sender = system_address,
