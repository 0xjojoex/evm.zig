...
pub const Recorder = struct {
    ...
    pub fn toOwnedLaneTransition(self: *Recorder, allocator: Allocator) !LaneTransition {
...
test "transaction observation delta owns compact reads writes restores and lifecycle" {
    ...
    var delta = try recorder.toOwnedLaneTransition(allocator);
...
test "transaction observation delta rejects more than one write index" {
    ...
    try std.testing.expectError(
        ...
        recorder.toOwnedLaneTransition(std.testing.allocator),
    );
}
